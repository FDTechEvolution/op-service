...
class AddressesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'line1' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'zipcode' => ['type' => 'string', 'fixed' => true, 'length' => 5, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => '48b5cf0d-ac5e-48ca-b143-90d9003f0a5f',
                ...
                'created' => '2019-10-02 05:21:37',
                'modified' => '2019-10-02 05:21:37'
            ],
        ];
        parent::init();
    }
